...
public class brokenarmtest : MonoBehaviour
{
    ...
    private void MousePressed(InputAction.CallbackContext context)
    {
        ...
        {
            if (hit.collider != null && (hit.collider.gameObject.layer == LayerMask.NameToLayer("Draggable Objects")))
            {
        ...
        if (hit2D.collider != null && (hit2D.collider.gameObject.layer == LayerMask.NameToLayer("Draggable Objects")))
            {
